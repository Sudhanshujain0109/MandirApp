...
const SideBar = forwardRef((props, ref) => {
    ...
    return (
        <Animated.View onStartShouldSetResponder={closeDrawer} style={[{transform: [{translateX: animated}],opacity:opacity},styles.animtedView]}>
            <View style={styles.innerView}>
                <LineButton
                    title='Add Relative'
                    onPress={()=>navigation.navigate("RelativeAdd" as never)}
                    style={{width:'100%',borderRadius:5,marginTop:-10,marginBottom:10,paddingHorizontal: 10,borderWidth:0,borderBottomWidth:1}}
                />
                <LineButton
                    title='About Us'
                    onPress={()=>navigation.navigate("About" as never)}
                    style={{width:'100%',borderRadius:5,marginBottom:10,paddingHorizontal: 10,borderWidth:0,borderBottomWidth:1}}
                />
                <LineButton
                    title='Content'
